...
- How do I search the Merriam Webster Dictionary for the word? How do I rule out all informal or archaic words?
  ...
  - If a word has multiple meanings in different contexts, how do you plan on choosing a meaning? I know there are natural language processing tools that you can use to figure out the specific meaning depending on the context. These are called using synsets and word disambiguation.
